...
CREATE TABLE contactos( id int not null AUTO_INCREMENT PRIMARY key, fecha datetime, correo varchar(75), nombre varchar(75), asunto varchar(30), comentario varchar(250) );
